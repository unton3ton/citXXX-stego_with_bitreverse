...
if __name__ == "__main__":
    ...
    img = cv2.imread('img/pic21in1.png', cv2.IMREAD_COLOR)
    cv2.imwrite("img/before.png",img)
    # # cv2.waitKey(0)
    ...
    img = example2(img)
    cv2.imwrite("img/corupt.png",img)
    ...
    img = cv2.imread('img/corupt.png', cv2.IMREAD_COLOR)
